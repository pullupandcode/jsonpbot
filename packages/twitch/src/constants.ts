...
export const CommandMessages = {
  About:
    `Jay  Phillz here. Director of Engineering, Web Dev Bootcamp Instructor, Mentor, Photography, Friend. Wanna know a bit more about me? peep https://jaysonjphillips.com/now to see what I'm up to!`,
  ...
  Project:
    `Our main project is our mood-tracking app called mindFULLness. Today, we're working on exploring NLP and sentiment analysis`,
